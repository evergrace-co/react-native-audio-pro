...
Implementation examples can be found in the [example project](https://github.com/evergrace-co/react-native-track-player/blob/main/example/src/services/PlaybackService.ts).
