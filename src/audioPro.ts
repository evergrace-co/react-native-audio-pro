...
export const AudioPro = {
  ...
  /**
   * Set whether the current track should repeat/loop
   *
   * @param isRepeating - Whether to repeat the track (default: false)
   */
  ...
  /**
   * Get whether the current track is set to repeat/loop
   *
   * @returns Whether the track is repeating (true) or not (false)
   */
  getIsRepeating() {
