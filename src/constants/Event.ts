export enum Event {
   ...
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#playbackprogressupdated
   **/
  PlaybackProgressUpdated = 'playback-progress-updated',
  /**
   * Fired when the user presses the play button.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remoteplay
   **/
  RemotePlay = 'remote-play',
  /**
   * Fired when the user presses the pause button.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remotepause
   **/
  RemotePause = 'remote-pause',
  /**
   * Fired when the user presses the stop button.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remotestop
   **/
  RemoteStop = 'remote-stop',
  /**
   * Fired when the user presses the next track button.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remotenext
   **/
  RemoteNext = 'remote-next',
  /**
   * Fired when the user presses the previous track button.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remoteprevious
   **/
  RemotePrevious = 'remote-previous',
  /**
   * Fired when the user presses the jump forward button.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remotejumpforward
   **/
  RemoteJumpForward = 'remote-jump-forward',
  /**
   * Fired when the user presses the jump backward button.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remotejumpbackward
   **/
  RemoteJumpBackward = 'remote-jump-backward',
  /**
   * Fired when the user changes the position of the timeline.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remoteseek
   **/
  RemoteSeek = 'remote-seek',
  /**
   * Fired when the user changes the rating for the track remotely.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remotesetrating
   **/
  RemoteSetRating = 'remote-set-rating',
  /**
   * Fired when the app needs to handle an audio interruption.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remoteduck
   **/
  RemoteDuck = 'remote-duck',
  /**
   * (iOS only) Fired when the user presses the like button in the now playing
   * center.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remotelike-ios-only
   **/
  RemoteLike = 'remote-like',
  /**
   * (iOS only) Fired when the user presses the dislike button in the now playing
   * center.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remotedislike-ios-only
   **/
  RemoteDislike = 'remote-dislike',
  /** (iOS only) Fired when the user presses the bookmark button in the now
   * playing center.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remotebookmark-ios-only
   **/
  RemoteBookmark = 'remote-bookmark',
  /**
   * (Android only) Fired when the user selects a track from an external device.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remoteplayid
   **/
  RemotePlayId = 'remote-play-id',
  /**
   * (Android only) Fired when the user searches for a track (usually voice search).
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remoteplaysearch
   **/
  RemotePlaySearch = 'remote-play-search',
  /**
   * (Android only) Fired when the user presses the skip button.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#remoteskip
   **/
  RemoteSkip = 'remote-skip',
  /**
   * (iOS only) Fired when chapter metadata is received.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#chaptermetadatareceived
   **/
  MetadataChapterReceived = 'metadata-chapter-received',
  /**
   * Fired when metadata is received at a specific time in the audio.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#timedmetadatareceived
   **/
  MetadataTimedReceived = 'metadata-timed-received',
  /**
   * Fired when common (static) metadata is received.
   * See https://evergrace-co.github.io/react-native-music-pro/docs/api/events#commonmetadatareceived
   **/
